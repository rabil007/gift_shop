    ...
    return (
        <section className="px-4 sm:px-6 mx-auto max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-8 items-center">
                <div className="flex flex-col items-start text-left lg:pr-8 animate-in slide-in-from-left-8 fade-in duration-1000 order-2 lg:order-1">
                    ...
                    <h1 className="text-5xl sm:text-6xl md:text-[6rem] lg:text-[6.5rem] font-serif text-[var(--landing-accent)] italic tracking-tight leading-[1.05] mb-6 sm:mb-8 pr-2 sm:pr-4">
                        of Gifting.
                    </h1>
                    <p className="text-base sm:text-lg md:text-xl text-neutral-600 font-medium max-w-lg leading-relaxed mb-8 sm:mb-12 animate-in slide-in-from-bottom-6 fade-in duration-1000 delay-150">
                    ...
                    <div className="flex flex-wrap items-center gap-4 sm:gap-6 animate-in slide-in-from-bottom-6 fade-in duration-1000 delay-300">
                ...
                <div className="relative w-full aspect-[4/5] max-w-[min(100%,22rem)] sm:max-w-lg mx-auto lg:ml-auto animate-in zoom-in-95 fade-in duration-1000 delay-300 order-1 lg:order-2">
                    ...
                    <div className="relative w-full h-full rounded-t-[1000px] rounded-b-none overflow-hidden m-2 sm:m-4 shadow-2xl border-2 sm:border-4 border-white bg-white">
                        <div
